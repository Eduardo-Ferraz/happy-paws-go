...
export function RegisterScreen({
  ...
  const handleWalkerChange = (field: keyof WalkerFields, value: string) => {
    setWalkerFields(prev => ({
      ...prev,
      [field]: value
    }));
    if (value.trim()) {
      setWalkerErrors(prev => ({
        ...prev,
        [field]: false
      }));
    }
  ...
  return <MobileFrame>
      <MobileHeader title="Criar Perfil" leftAction={<Button variant="ghost" size="iconSm" onClick={onBack}>
            <ArrowLeft size={20} />
          </Button>} />
      ...
      <MobileContent className="pb-24">
        ...
        <div className="flex bg-muted rounded-2xl p-1 mb-6">
          <button onClick={() => setActiveTab("tutor")} className={cn("flex-1 flex items-center justify-center gap-2 py-3 rounded-xl font-semibold text-sm transition-all", activeTab === "tutor" ? "bg-card text-foreground shadow-card" : "text-muted-foreground")}>
            <Dog size={18} />
            Sou Tutor
          </button>
          <button onClick={() => setActiveTab("walker")} className={cn("flex-1 flex items-center justify-center gap-2 py-3 rounded-xl font-semibold text-sm transition-all", activeTab === "walker" ? "bg-card text-foreground shadow-card" : "text-muted-foreground")}>
            <User size={18} />
            Sou Passeador
          </button>
        </div>

        {activeTab === "tutor" ? <TutorForm fields={tutorFields} errors={tutorErrors} onChange={handleTutorChange} inputErrorClass={inputErrorClass} /> : <WalkerForm fields={walkerFields} errors={walkerErrors} onChange={handleWalkerChange} selectedSize={selectedSize} onToggleSize={id => setSelectedSize(prev => prev.includes(id) ? prev.filter(s => s !== id) : [...prev, id])} inputErrorClass={inputErrorClass} />}
  ...
  return <>
      ...
      <div className="space-y-4">
        <div>
          ...
          <Input id="tutor-name" placeholder="Seu nome completo" value={fields.name} onChange={e => onChange("name", e.target.value)} className={cn("mt-1.5", errors.name && inputErrorClass)} />
        ...
        <div>
          ...
          <div className="relative mt-1.5">
            ...
            <Input id="tutor-email" type="email" placeholder="seu@email.com" value={fields.email} onChange={e => onChange("email", e.target.value)} className={cn("pl-10", errors.email && inputErrorClass)} />
          </div>
        ...
        <div>
          ...
          <div className="relative mt-1.5">
            ...
            <Input id="tutor-phone" type="tel" placeholder="(11) 99999-9999" value={fields.phone} onChange={e => onChange("phone", e.target.value)} className={cn("pl-10", errors.phone && inputErrorClass)} />
          </div>
        ...
        <div>
          ...
          <div className="relative mt-1.5">
            ...
            <Input id="tutor-address" placeholder="Seu bairro ou endereço" value={fields.address} onChange={e => onChange("address", e.target.value)} className={cn("pl-10", errors.address && inputErrorClass)} />
          </div>
        ...
        <div>
          ...
          <Input id="tutor-cpf" placeholder="000.000.000-00" value={fields.cpf} onChange={e => onChange("cpf", e.target.value)} className={cn("mt-1.5", errors.cpf && inputErrorClass)} />
  ...
  return <>
      ...
      <div className="space-y-4">
        <div>
          ...
          <Input id="walker-name" placeholder="Seu nome completo" value={fields.name} onChange={e => onChange("name", e.target.value)} className={cn("mt-1.5", errors.name && inputErrorClass)} />
          {errors.name && <p className="text-xs text-destructive mt-1">Campo obrigatório</p>}
        </div>
        ...
        <div>
          ...
          <div className="relative mt-1.5">
            <Mail size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground" />
            <Input id="walker-email" type="email" placeholder="seu@email.com" value={fields.email} onChange={e => onChange("email", e.target.value)} className={cn("pl-10", errors.email && inputErrorClass)} />
          </div>
          {errors.email && <p className="text-xs text-destructive mt-1">Campo obrigatório</p>}
        </div>
        ...
        <div>
          ...
          <div className="relative mt-1.5">
            <Phone size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground" />
            <Input id="walker-phone" type="tel" placeholder="(11) 99999-9999" value={fields.phone} onChange={e => onChange("phone", e.target.value)} className={cn("pl-10", errors.phone && inputErrorClass)} />
          </div>
          {errors.phone && <p className="text-xs text-destructive mt-1">Campo obrigatório</p>}
        </div>
        ...
        <div>
          ...
          <div className="relative mt-1.5">
            <MapPin size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground" />
            <Input id="walker-address" placeholder="Seu bairro ou endereço" value={fields.address} onChange={e => onChange("address", e.target.value)} className={cn("pl-10", errors.address && inputErrorClass)} />
          </div>
          {errors.address && <p className="text-xs text-destructive mt-1">Campo obrigatório</p>}
        </div>
        ...
        <div>
          ...
          <Input id="walker-cpf" placeholder="000.000.000-00" value={fields.cpf} onChange={e => onChange("cpf", e.target.value)} className={cn("mt-1.5", errors.cpf && inputErrorClass)} />
          {errors.cpf && <p className="text-xs text-destructive mt-1">Campo obrigatório</p>}
        </div>

        <div>
          <Label htmlFor="walker-bio">Biografia</Label>
          <Input id="walker-bio" placeholder="Conte um pouco sobre você..." value={fields.bio} onChange={e => onChange("bio", e.target.value)} className={cn("mt-1.5", errors.bio && inputErrorClass)} />
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <Input id="walker-price" type="number" placeholder="R$ 40" value={fields.price} onChange={e => onChange("price", e.target.value)} className={cn("mt-1.5", errors.price && inputErrorClass)} />
            {errors.price && <p className="text-xs text-destructive mt-1">Obrigatório</p>}
          </div>
          <div>
            <Label htmlFor="walker-maxDogs">Máx. de cães</Label>
            <Input id="walker-maxDogs" type="number" placeholder="3" value={fields.maxDogs} onChange={e => onChange("maxDogs", e.target.value)} className={cn("mt-1.5", errors.maxDogs && inputErrorClass)} />
        ...
        <div>
          ...
          <FilterChips chips={sizeOptions} selected={selectedSize} onToggle={onToggleSize} />
        </div>
      </div>
    </>;
}